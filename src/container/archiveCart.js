...
class archiveCart {
    ...
    async createCart(){
        try{
            ...
            await fs.promises.writeFile(route, JSON.stringify ([...dataFileParse]))
    ...
    async addCartproduct(obj){
        try{
            const cartfile = await fs.promises.readFile(this.route, 'utf-8');
            ...
            await fs.promises.writeFile(this.route, JSON.stringify ([...cartFileParse]))
    ...
    async delteCart(obj){
        try{
            ...
            await fs.promises.writeFile(this.route, JSON.stringify(filterDelete))
